...
public class QualityPolygons7 {
    private static final long TIME_OFFSET = 9900;
    private static final long[] TIME_OFFSETS = { 9900, 9700, 8000, 6500, 4000, 3000, 2000, 1000, 1000, 1000, 1000 };
    private long time;
